...
\section*{Risk Assessment and Impact Analysis}
...
-   For a small team, the most realistic threat scenarios are listed below.
    ...
    -   A mistaken \texttt{DROP TABLE} or \texttt{rm -rf} wipes something important
...
-   The recovery checklist should be a numbered point-form list of concrete actions.
    ...
    For example:
    1. Send a message to \texttt{\#incidents} in Slack.
    2. SSH into the database host.
    3. Run \texttt{./restore-db.sh prod 2026-07-25}.
...
\section*{Communication and Notification}
...
\section*{Cybersecurity and Ransomware Preparedness}
...
\section*{People and Knowledge Resilience}
...
-   Verify that the backup scripts are running
    ...
    A "success" email from a task that has been writing to \texttt{/dev/null} for a month
